...
public class Main
{
    private static final Type field_152370_a = new ParameterizedType()
    {
    ...
    public static void main(String[] p_main_0_)
    {
        ...
        if (var23 != null)
        {
            try
            {
                var24 = new Proxy(java.net.Proxy.Type.SOCKS, new InetSocketAddress(var23, ((Integer)var21.valueOf(var8)).intValue()));
            }
