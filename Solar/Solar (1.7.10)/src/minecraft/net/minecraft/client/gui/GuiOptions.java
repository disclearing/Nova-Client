...
public class GuiOptions extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(8675309, this.width / 2 + 5, this.height / 6 + 48 - 6, 150, 20, "Solar Discord"));
        ...
        if (p_146284_1_.enabled)
        {
            ...
            if (p_146284_1_.id == 8675309)
            {
            	...
            	if (Desktop.isDesktopSupported() && Desktop.getDesktop().isSupported(Desktop.Action.BROWSE)) {
            	    try {
						Desktop.getDesktop().browse(new URI("https://discord.gg/dEWrzqH"));
					} catch (IOException e) {
    ...
    public void drawScreen(int p_73863_1_, int p_73863_2_, float p_73863_3_)
    {
        ...
        this.drawString(this.fontRendererObj, "Nova v0.4b Rebrand", 2, this.height - 11, new Color(50, 50, 50, 50).hashCode());
