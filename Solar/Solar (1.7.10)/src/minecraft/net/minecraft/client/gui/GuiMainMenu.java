...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    private static final ResourceLocation globe = new ResourceLocation("textures/solar/globe.png");
    ...
    public GuiMainMenu()
    {
        ...
        try
        {
            this.splashText = Minecraft.getName() + " v" + Minecraft.version + "!";
        }
    ...
    public void initGui()
    {
        ...
        if (var1.get(2) + 1 == 7 && var1.get(5) == 4)
        {
            this.splashText = "Happy birthday, PlumpOrange!";
        }
        else if (var1.get(2) + 1 == 12 && var1.get(5) == 24)
        {
            this.splashText = "Merry Plump-mas!";
        }
        else if (var1.get(2) + 1 == 1 && var1.get(5) == 1)
        {
            this.splashText = "Happy new orange!";
        }
        else if (var1.get(2) + 1 == 10 && var1.get(5) == 31)
        {
            this.splashText = "OOoooOOOoooo! An Orange!";
        }

        boolean var2 = true;
        int var3 = this.height / 2 + 30;
        ...
        {
            this.addSingleplayerMultiplayerButtons(var3, 22);
        }

        //this.buttonList.add(new GuiButton(0, 2, 2, 70, 20, "Options", 0x00000000));
        this.buttonList.add(new GuiButton(4, this.width - 20 - 2, 2, 20, 20, "X"));
        this.buttonList.add(new GuiButton(5, this.width / 2 - 10, this.height - 20, 20, 20, " "));
    ...
    {
        this.buttonList.add(new GuiButton(1, this.width / 2 - 50, p_73969_1_, 100, 20, I18n.format("SINGLEPLAYER", new Object[0])));
        this.buttonList.add(new GuiButton(2, this.width / 2 - 50, p_73969_1_ + p_73969_2_ * 1, 100, 20, I18n.format("MULTIPLAYER", new Object[0])));
    }
    ...
    public void drawScreen(int p_73863_1_, int p_73863_2_, float p_73863_3_)
    {
        ...
        this.drawspaceBackground(p_73863_1_, p_73863_2_);
        ...
        GL11.glPushMatrix();
        GL11.glTranslatef((float)(this.width / 2 + 90), 85.0F, 0.0F);
        ...
        //this.drawCenteredString(this.fontRendererObj, this.splashText, 0, -8, 16739840);
        GL11.glPopMatrix();
        String var9 = Minecraft.getName() + " v" + Minecraft.version;
        mc.fontRenderer.setFancy(false);
        //mc.fontRenderer.drawString("Test :sob:", 100, 100, 0xFFFFFF);
        mc.fontRenderer.setFancy(true);
        if (this.mc.isDemo())
        {
            var9 = var9 + " Demo";
        ...
        //this.mc.cFontRenderer.drawString(var9, 2, this.height - 10, 0xFFFFFFFF);
        //this.drawString(this.fontRendererObj, var9, 2, this.height - 10, 0x80FFFFFF);
        String var10 = "";
        //this.mc.cFontRenderer.drawString(var10, this.width - this.mc.cFontRenderer.getStringWidth(var10) - 2, this.height - 10, 0xFFFFFFFF);

        if (this.field_92025_p != null && this.field_92025_p.length() > 0)
        {
            drawRect(this.field_92022_t - 2, this.field_92021_u - 2, this.field_92020_v + 2, this.field_92019_w - 1, 1428160512);
            this.mc.cFontRenderer.drawString(this.field_92025_p, this.field_92022_t, this.field_92021_u, -1);
            this.mc.cFontRenderer.drawString(this.field_146972_A, (this.width - this.field_92024_r) / 2, ((GuiButton)this.buttonList.get(0)).field_146129_i - 12, -1);
        }
        options = new GuiCogButton("options", 2, 2, 22, 22, new Color(200, 200, 200, 40), this, true);
        options.draw(p_73863_1_ + width / 2, p_73863_2_ + height / 2);
        ...
        //this.drawRoundRect(var6 - 50, var7 - 25, var6 + 50, var7 + 25, 15, 30, 0xFFFFFFFF);
        var7 = this.height - 10;
        
        var6 = (int) (var6 / scale) - var5 / 2 - 3;
        var7 = (int) (var7 / scale) - var5 / 2;
        this.mc.getTextureManager().bindTexture(globe);
        GL11.glEnable(GL11.GL_ALPHA_TEST);
        GL11.glEnable(GL11.GL_BLEND);
        GL11.glBlendFunc(GL11.GL_SRC_ALPHA, GL11.GL_ONE_MINUS_SRC_ALPHA);
        GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
        ...
        mc.fontRenderer.setFancy(false);
        if (first) {
            drawRect(0, 0, mc.displayWidth, mc.displayHeight, new Color(20, 20, 20, 255 - state).hashCode());
            state+=10;
            if (state >= 255) first = false;
        }
        if (inc)
            if (breath + 0.00033 > 0.02) inc = false;
            else breath+= 0.00033;
        else
            if (breath - 0.00033 < 0.0) inc = true;
            else breath-= 0.00033;
    }
    ...
    protected void mouseClicked(int p_73864_1_, int p_73864_2_, int p_73864_3_)
    {
        ...
        if (p_73864_3_ == 0) if(options != null) if (options.isOnButton(p_73864_1_ + width / 2, p_73864_2_ + height / 2)) {
