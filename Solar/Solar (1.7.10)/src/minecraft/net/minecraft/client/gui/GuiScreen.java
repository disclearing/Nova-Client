...
public class GuiScreen extends Gui
{
    ...
    private int backgroundState = 100;
    ...
    public void drawBlurredBackground() {
    	this.drawGradientRect(0, 0, this.width, this.height, new Color(0, 0, 0, 200 - backgroundState * 2).hashCode() ,0x00000000);
    	//this.drawGradientRect(this.width, this.height, 0, 0, new Color(0, 0, 0, 100 - backgroundState).hashCode() ,0x00000000);
    	this.drawGradientRect(this.width, this.height, 0, 0, new Color(0, 0, 0, 200 - backgroundState * 2).hashCode() ,0x00000000);
    	if (backgroundState > 0) backgroundState-=7;
    }
    
    public void drawBlurredBackgroundStationary() {
    	this.drawGradientRect(0, 0, this.width, this.height, new Color(0, 0, 0, 200).hashCode() ,0x00000000);
    	//this.drawGradientRect(this.width, this.height, 0, 0, new Color(0, 0, 0, 100 - backgroundState).hashCode() ,0x00000000);
    	this.drawGradientRect(this.width, this.height, 0, 0, new Color(0, 0, 0, 200).hashCode() ,0x00000000);
    }

    public void drawspaceBackground(int p_73863_1_, int p_73863_2_) {
        float scale = (this.width / 256) * 1.75f;
        ...
        this.drawTexturedModalRect(0, 0, (p_73863_1_ /50), (p_73863_2_/50), 512, 512);
        GL11.glScalef(mscale, mscale, mscale);
        this.mc.getTextureManager().bindTexture(backOverlay);
        this.drawTexturedModalRect(0, 0, -(p_73863_1_ /15) + 100, -(p_73863_2_/15) + 20, this.width, this.height);
        this.drawTexturedModalRect(0, 0, -(p_73863_1_ /10) + 250, -(p_73863_2_/10) + 75, this.width, this.height);
        this.drawTexturedModalRect(0, 0, -(p_73863_1_ /5), -(p_73863_2_/5), this.width, this.height);
        GL11.glDisable(GL11.GL_ALPHA_TEST);
    }



    public void drawSolidBackground(int color) {
