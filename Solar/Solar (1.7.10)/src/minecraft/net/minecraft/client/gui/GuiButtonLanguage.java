...
public class GuiButtonLanguage extends GuiButton
{
    ...
    public GuiButtonLanguage(int p_i1041_1_, int p_i1041_2_, int p_i1041_3_, int i, int j, String string)
    {
        super(p_i1041_1_, p_i1041_2_, p_i1041_3_, i, j, "");
    }
    ...
    public void drawButton(Minecraft p_146112_1_, int p_146112_2_, int p_146112_3_)
    {
        if (this.field_146125_m)
        {
            ...
            this.drawRect(this.field_146128_h, this.field_146129_i, this.field_146128_h + this.field_146120_f, this.field_146129_i + this.field_146121_g, 0x80FFFFFF);
            this.drawString(Minecraft.getMinecraft().fontRenderer, "⌘",  this.field_146128_h, this.field_146129_i, 0xFFFFFFFF);
