...
public abstract class GuiSlot
{
    ...
    public GuiSlot(Minecraft p_i1052_1_, int p_i1052_2_, int p_i1052_3_, int p_i1052_4_, int p_i1052_5_, int p_i1052_6_, boolean server)
    {
        this.field_148161_k = p_i1052_1_;
        this.field_148155_a = p_i1052_2_;
        this.field_148158_l = p_i1052_3_;
    ...
    private static final ResourceLocation backBase = new ResourceLocation("textures/solar/BackBase.png");
    private static final ResourceLocation backOverlay = new ResourceLocation("textures/solar/BackOverlay.png");
    public void drawspaceBackground(int p_73863_1_, int p_73863_2_) {
        float scale = (this.mc.displayWidth / 256) * 1.75f;
        float mscale = (float)Math.pow(scale,-1);
        this.mc.getTextureManager().bindTexture(backBase);
        GL11.glEnable(GL11.GL_ALPHA_TEST);
        GL11.glEnable(GL11.GL_BLEND);
        //GL11.glBlendFunc(GL11.GL_SRC_ALPHA, GL11.GL_ONE_MINUS_SRC_ALPHA);
        GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
        GL11.glScalef(scale, scale, scale);
        this.drawTexturedModalRect(0, 0, (p_73863_1_ /50), (p_73863_2_/50), 256, 256);
        GL11.glScalef(mscale, mscale, mscale);
        this.mc.getTextureManager().bindTexture(backOverlay);
        this.drawTexturedModalRect(0, 0, -(p_73863_1_ /15) + 100, -(p_73863_2_/15) + 20, this.mc.displayWidth, this.mc.displayHeight);
        this.drawTexturedModalRect(0, 0, -(p_73863_1_ /10) + 250, -(p_73863_2_/10) + 75, this.mc.displayWidth, this.mc.displayHeight);
        this.drawTexturedModalRect(0, 0, -(p_73863_1_ /5), -(p_73863_2_/5), this.mc.displayWidth, this.mc.displayHeight);
    ...
    {
    	//this.drawRect(0, 0, Minecraft.getMinecraft().displayWidth, Minecraft.getMinecraft().displayHeight, 0xFF0C0C0C);
            ...
            else
            {
                for (; !this.field_148161_k.gameSettings.touchscreen && Mouse.next(); this.field_148161_k.currentScreen.handleMouseInput())
                {
                    ...
                    if (var7 != 0)
                    {
                        ...
                        this.field_148169_q += (float)((var7 / 3));
                    }
                }
        ...
        GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
        float var17 = 16.0F;
        //this.drawRect(this.field_148152_e, this.field_148154_c, this.field_148152_e + (int)(this.field_148152_e / var17), this.field_148154_c + (int)((this.field_148169_q) / var17), 0xFF0C0C0C);
...
//        var16.draw();
        //this.drawspaceBackground(p_148128_1_, p_148128_2_);
        ...
        byte var18 = 8;
        this.drawRect(0, 0, Minecraft.getMinecraft().displayWidth, this.field_148153_b, 0xFF000000);
        this.drawRect(0,Minecraft.getMinecraft().currentScreen.height - (Minecraft.getMinecraft().currentScreen.height - this.field_148154_c), Minecraft.getMinecraft().displayWidth, Minecraft.getMinecraft().displayHeight, 0xFF000000);
        GL11.glEnable(GL11.GL_BLEND);
    ...
    {
        this.drawRect(p_148136_1_, p_148136_2_, p_148136_1_ + p_148136_3_, p_148136_2_ + p_148136_4_, 0xFF000000);
