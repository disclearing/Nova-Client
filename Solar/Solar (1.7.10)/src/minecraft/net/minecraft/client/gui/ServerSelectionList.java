...
public class ServerSelectionList extends GuiListExtended
{
    ...
    private final List featuredServers = Lists.newArrayList();
    ...
    {
        if (p_148180_1_ < this.featuredServers.size()) {
            return (GuiListExtended.IGuiListEntry)this.featuredServers.get(p_148180_1_);
        } else {
            p_148180_1_ -= this.featuredServers.size();
    ...
    {
        return this.field_148198_l.size() + 1 + this.field_148199_m.size() + this.featuredServers.size();
    }
    ...
    public void doFeatured(FeaturedServerList p_148195_1_)
    {
        this.featuredServers.clear();

        for (int var2 = 0; var2 < p_148195_1_.countServers(); ++var2)
        {
            this.featuredServers.add(new ServerListEntryNormal(this.field_148200_k, p_148195_1_.getServerData(var2)));
        }
    }
