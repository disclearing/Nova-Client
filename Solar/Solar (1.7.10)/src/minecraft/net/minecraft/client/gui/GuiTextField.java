...
public class GuiTextField extends Gui
{
    ...
    {
        FontRenderer.renderEmojis = false;
        if (this.func_146176_q())
        {
            if (this.func_146181_i())
            {
                drawRoundedRect(this.field_146209_f - 1, this.field_146210_g - 1, this.field_146209_f + this.field_146218_h + 1, this.field_146210_g + this.field_146219_i + 1,3, -6250336);
                drawRoundedRect(this.field_146209_f, this.field_146210_g, this.field_146209_f + this.field_146218_h, this.field_146210_g + this.field_146219_i, 3, -16777216);
            }
            ...
            if (FontRenderer.isFancy) var11 = (int)(var11 * 1.25);

            if (var6)
            {
                if (var13)
                {
                    Gui.drawRoundedRect(var11, var8 - 1, var11 + 1, var8 + 1 + this.field_146211_a.FONT_HEIGHT, 2, -3092272);
                }
                else
                {
        ...
        FontRenderer.renderEmojis = true;
    }
