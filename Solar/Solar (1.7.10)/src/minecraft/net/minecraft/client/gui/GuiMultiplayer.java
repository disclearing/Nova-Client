...
import net.minecraft.client.multiplayer.FeaturedServerList;
...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback
{
    ...
    private FeaturedServerList featuredServerList;
    ...
    public void initGui()
    {
        ...
        if (!this.field_146801_C)
        {
            ...
            this.featuredServerList = new FeaturedServerList(this.mc);
            this.field_146804_i.loadServerList();
            this.featuredServerList.loadServerList();
            ...
            this.field_146803_h.doFeatured(this.featuredServerList);
    ...
    public void confirmClicked(boolean p_73878_1_, int p_73878_2_)
    {
        ...
        if (this.field_146803_h.func_148193_k() < this.featuredServerList.countServers() && var3 != null) {
            ...
            if (this.field_146807_u)
            {
                ...
                {
                    this.field_146804_i.removeServerData(this.field_146803_h.func_148193_k() - this.featuredServerList.countServers());
    ...
    {
        this.mc.displayGuiScreen(new GuiNovaConnecting(this, this.mc, p_146791_1_));
    }
    ...
    public FeaturedServerList getFeaturedServerList() { return this.featuredServerList;}
}
