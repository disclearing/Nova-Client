...
public class PlayerProfileCache
{
    ...
    public void func_152657_b()
    {
        ...
        label:
        {
            try
            {
                two = Files.newReader(this.field_152665_g, Charsets.UTF_8);
                one = (List)this.gson.fromJson(two, new RemadeTypeFix());
                break label;
            }
        ...
        if (one != null)
        {
            ...
            one = Lists.reverse(one);
            Iterator var12 = one.iterator();
