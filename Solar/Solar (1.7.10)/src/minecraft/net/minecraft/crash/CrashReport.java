...
public class CrashReport
{
    ...
    private void populateEnvironment()
    {
        this.theReportCategory.addCrashSectionCallable("Minecraft Version", new Callable()
        {
            ...
            public String call1()
            {
                return Minecraft.getName() + " (" + Minecraft.version + ") 1.7.10";
            }
    ...
    public String getCompleteReport()
    {
        ...
        var1.append("\n\n---- Solar Crash Report ----\n\n");
        var1.append("\n\nUser Data: ");
        var1.append(Minecraft.getMinecraft().getSession().getUsername() + ":" + Minecraft.getMinecraft().getSession().getPlayerID() + "\n");
        var1.append("\nClient Output: ");
        var1.append(Minecraft.output);
